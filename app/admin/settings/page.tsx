        ...
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div>
                ...
                <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1">
                    Gérez les frais de livraison, seuil gratuit, WhatsApp et disponibilité du marché.
                </p>
            </div>

            {/* Alertes Toast */}
            {successMessage && (
                <div className="p-3.5 sm:p-4 bg-emerald-50 border border-emerald-200 rounded-2xl flex items-center gap-3 text-emerald-800 text-xs sm:text-sm font-bold animate-in fade-in slide-in-from-top-2">
            ...
            {errorMessage && (
                <div className="p-3.5 sm:p-4 bg-red-50 border border-red-200 rounded-2xl flex items-center gap-3 text-red-800 text-xs sm:text-sm font-bold animate-in fade-in slide-in-from-top-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-white p-4 sm:p-8 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-3 pb-3 sm:pb-4 border-b border-slate-100">
                        ...
                        <div>
                            <h2 className="text-base sm:text-lg font-black text-slate-900">Tarification de la Livraison</h2>
                ...
                <div className="bg-white p-4 sm:p-8 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-3 pb-3 sm:pb-4 border-b border-slate-100">
                        ...
                        <div>
                            <h2 className="text-base sm:text-lg font-black text-slate-900">Statut de la Boutique</h2>
                            <p className="text-xs text-slate-400 font-medium">Contrôle des ouvertures et des prises de commandes</p>
                        </div>
                    </div>

                    <div className="flex flex-col sm:flex-row sm:items-center justify-between p-3.5 sm:p-4 bg-slate-50 rounded-2xl border border-slate-100 gap-3 sm:gap-4">
                        <div>
                            <div className="flex items-center gap-2">
                                <span className={`w-3 h-3 rounded-full ${form.storeOpen ? 'bg-emerald-500 animate-pulse' : 'bg-red-500'}`} />
                                <span className="font-bold text-slate-900 text-sm sm:text-base">
                                    {form.storeOpen ? 'Boutique Ouverte (Commandes Actives)' : 'Boutique Fermée'}
                                </span>
                            </div>
                            <p className="text-xs text-slate-500 mt-1">
                                {form.storeOpen
                                    ? 'Les clients peuvent commander normalement en ligne.'
                                    : 'Les nouvelles commandes sont suspendues pour inventaire ou maintenance.'}
                            </p>
                        </div>
                        ...
                        <button
                            ...
                            className={`w-full sm:w-auto px-5 py-2.5 rounded-xl font-bold text-xs sm:text-sm transition-all shadow-sm flex items-center justify-center active:scale-95 ${
                                form.storeOpen
                ...
                <div className="bg-white p-4 sm:p-8 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-3 pb-3 sm:pb-4 border-b border-slate-100">
                        ...
                        <div>
                            <h2 className="text-base sm:text-lg font-black text-slate-900">Communication & Contact</h2>
                            <p className="text-xs text-slate-400 font-medium">WhatsApp et message promotionnel</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3.5 sm:px-4 py-2.5 sm:py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 focus:bg-white focus:ring-2 focus:ring-emerald-500"
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3.5 sm:px-4 py-2.5 sm:py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium text-slate-900 focus:bg-white focus:ring-2 focus:ring-emerald-500"
                            />
                            <p className="text-xs text-slate-400 mt-1 font-medium">
                                Visible par tous les visiteurs sur le bandeau en haut de page.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2.5 sm:gap-4 pt-2 sm:pt-4">
                    <button
                        type="button"
                        onClick={fetchSettings}
                        disabled={saving}
                        className="w-full sm:w-auto px-6 py-3 bg-white border border-slate-200 text-slate-600 rounded-xl font-bold text-sm hover:bg-slate-50 flex items-center justify-center gap-2 transition-all shadow-sm active:scale-95"
                    >
                    ...
                    <button
                        type="submit"
                        disabled={saving}
                        className="w-full sm:w-auto px-8 py-3 bg-emerald-600 text-white rounded-xl font-bold text-sm hover:bg-emerald-700 shadow-xl shadow-emerald-200 flex items-center justify-center gap-2 transition-all transform active:scale-95 disabled:opacity-50"
                    >
